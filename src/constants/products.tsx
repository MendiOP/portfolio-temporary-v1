...
export const products = [
  ...
  <p>
    ...
    interacting with a vibrant learning community. Whether you are a student,
  ...
  <p>
    ...
    enroll and participate. Authentication state is managed via Reacts Context API,
  ...
  <p>
    ...
    milestones dynamically. Each lesson completion triggers an update in the users
